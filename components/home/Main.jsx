...
export default function Main() {
  return (
    <div>
      ...
      <div>
        <button className="absolute w-24 h-24 top-50 bottom-20 right-20 z-100 bg-[#25d366]"><img src="https://cdn-icons-png.flaticon.com/512/3536/3536445.png" /></button>
      </div>
    </div>
  );
}
